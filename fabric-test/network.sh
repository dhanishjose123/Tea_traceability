...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.example.com docker_peer0.farmers.example.com docker_peer0.aggregators.example.com docker_peer0.retailers.example.com docker_peer0.consumers.example.com docker_peer0.bank.example.com
