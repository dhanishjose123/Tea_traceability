...
process.env.WORKLOAD_DIR = 'workload_9_cached_50kg';
process.env.PRELOAD_CACHE_DIR = path.join(rootDir, 'tmp', 'preload-cache-50kg');
process.env.LATENCY_BENCHMARKS = benchmarks.join(',');

console.log('Exclusive 50 kg latency pipeline');
